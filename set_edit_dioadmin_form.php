   ...
   <!-- <a href="add_diocese.php" class="btn btn-inverse"><i class="icon-plus-sign icon-large"></i> Add Diocese</a> -->
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i>Set Diocesan Admin</div>
                            </div>
								...
								<form method="post" id="update_diocese_form">
										<div class="control-group">
                                          <div class="controls">
                                            ...
                                            <input class="input focused " value="<?php echo $row['fname'].' '. $row['lname']; ?>" name="diocese_name" id="focusedInput" type="text" placeholder = "Class Name" required readonly>
                                          </div>
                                        </div>			
