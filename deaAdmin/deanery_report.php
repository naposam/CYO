...
<body >
        ...
        <div class="container-fluid">
           ...
           $query=mysqli_query($mysqli,"SELECT DISTINCT(deanery.deanery_name),deanery.*,annual_registration_paymenttbl.status from deanery left JOIN annual_registration_paymenttbl  on annual_registration_paymenttbl.deanery_id=deanery.deanery_id  where annual_registration_paymenttbl.status=1 and deanery.deanery_id='$deanery_id' ") or die(mysqli_error($mysqli));
