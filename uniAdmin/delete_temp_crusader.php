...
if(isset($_GET['del_id'])){
 	...
 	mysqli_query($mysqli,"DELETE FROM tempcrusaders WHERE crusader_id='$del_id'")or die(mysqli_error($mysqli));
 ...
 echo "<script>document.location='unconfirm_registration.php'</script>";
