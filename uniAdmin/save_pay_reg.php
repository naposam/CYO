...
if(empty($trans_id)) {
	...
	$sql= "INSERT INTO annual_registration_paymenttbl(crusader_id,amount,datepaid,payment_type,status,period,trans_id,section,unit_id,parish_id,deanery_id,diocese_id)VALUES('$crusader_id','$amount',NOW(),'$payment_type','$status','$period','$trans_id','$section','$unit_id','$parish_id','$deanery_id','$diocese_id')";
	if(mysqli_query($mysqli,$sql)){
		header("location: searchreg.php");
	}
...
// }
    ...
    $status=true;
    $payment_type="Manual";
	$sql= "INSERT INTO annual_registration_paymenttbl(crusader_id,amount,datepaid,payment_type,status,period,section,unit_id,parish_id,deanery_id,diocese_id)VALUES('$crusader_id','$amount',NOW(),'$payment_type','$status','$period','$section','$unit_id','$parish_id','$deanery_id','$diocese_id')";
	if(mysqli_query($mysqli,$sql)){
		header("location: searchreg.php");
	}
