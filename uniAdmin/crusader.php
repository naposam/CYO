...
<style type="text/css">
    ...
    <body >
        ...
        $query=mysqli_query($mysqli,"SELECT *,year(curDate())-year(DOB) as age, unit.unit_name FROM crusaders LEFT JOIN unit on crusaders.unit=unit.unit_id where unit.unit_name='$unit'") or die(mysqli_error($mysqli));
                    ...
                    <p style="margin:0;padding:0;font-weight:bold; font-size: 20px;text-align: center;">LIST OF CRUSADERS: <span style="color: black; font-weight: bolder; font-family: sans-serif;"><?php echo $fetch['unit_name'].' '.'UNIT';?></span></p>
