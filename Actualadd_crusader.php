                     ...
                     <div class="row-fluid">
						...
						<!-- span 4 -->
										<div class="span4">
											...
											<input type="file" class="input-block-level"  name="image" placeholder="First Name" accept="image/*">
											<label>FIRST NAME:</label>
											<input type="text" class="input-block-level"  name="fname" placeholder="First Name" required onkeyup="letteronly(this)" autofocus value="<?php echo $fname;?>">
											<label>MIDDLE NAME:</label>
											<input type="text" class="input-block-level"  name="mname" placeholder="Middle Name"   value="<?php echo $mname;?>">
						...
						<div class="span4">
											...
											<input type="date" name="dob" id="dob" value="<?php echo $userDob;?>">
