...
<?php include('session.php'); ?>
    ...
    <body style="background: url(images/colorful.jpg) repeat scroll 0 0 rgba(0, 0, 0, 0) !important; background-repeat: no-repeat !important; background-size: cover !important;">
        ...
        <div class="container-fluid">
                ...
                <div class="span6" id="">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 
							$query = mysqli_query($mysqli,"select * from diocese")or die(mysqli_error($mysqli));
							$count = mysqli_num_rows($query);
							?>
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Diocese List</div>
                                <div class="muted pull-right">
									Number of Diocese: <span class="badge badge-info"><?php echo $count; ?></span>
								</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_class1.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query1 = mysqli_query($mysqli,"select * from diocese")or die(mysqli_error($mysqli));
			...
			<a href="delete_diocese.php?del_id=<?php echo $row['diocese_id'];?>" onclick="return confirm('Are you sure you want to delete Diocese?');" class="btn btn-danger" id="delete<?php echo $row['diocese_id'];?>" title="Click to delete " data-toggle="modal">Delete</a>
            <script type="text/javascript">
			$(document).ready(function(){
