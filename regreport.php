        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="">
                     <div class="row-fluid">
						...
						?>
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" style="color:green;"><i class="icon-reorder icon-large" ></i><strong>PAID CRUSADERS LIST - NATIONWIDE</strong> </div>
                    ...
                    <p style="margin:0;padding:0;font-weight:bold; font-size: 20px;text-align: center;">PAID NATIONAL REGISTRATION LIST OF CRUSADERS</p>
