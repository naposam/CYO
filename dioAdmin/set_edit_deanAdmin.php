...
<?php $get_id = $_GET['id']; ?>
    <body style="background: url(../images/colorful.jpg) repeat scroll 0 0 rgba(0, 0, 0, 0) !important; background-repeat: no-repeat !important; background-size: cover !important;">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('sidebar_edit_deanadmin.php'); ?>
				<div class="span3" id="">
				<?php include('set_edit_deandmin_form.php'); ?>		   			
				</div>
								...
								<form action="delete_class1.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="80">
												<a data-placement="left" id="edit<?php echo $id; ?>" title="Click to Edit" href="set_edit_deanAdmin.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i> Edit</a>
														<script type="text/javascript">
														$(document).ready(function(){
