   ...
   <!-- <a href="add_diocese.php" class="btn btn-inverse"><i class="icon-plus-sign icon-large"></i> Add Diocese</a> -->
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i>Set Parish Admin</div>
                            </div>
								...
								<form method="post" id="update_parish_form">
										<div class="control-group">
                                          <div class="controls">
                                            ...
                                            <input class="input focused " value="<?php echo $row['fname'].' '. $row['lname']; ?>" name="deanery_name" id="focusedInput" type="text" placeholder = "Class Name" required>
                                          </div>
                                        </div>			
			...
			jQuery(document).ready(function($){
				$("#update_parish_form").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "update_parishAdmin.php",
						data: formData,
						success: function(html){
							$.jGrowl("Class Successfully  Updated", { header: 'Class Updated' });
							window.location = 'setparishadmin.php';  
						}
					});
				});
			});
