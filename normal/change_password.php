...
<style type="text/css">
  ...
  <body id="login">
	...
	<?php
			$query = mysqli_query($mysqli,"select * from login_tb where user_id = '$session_id'")or die(mysql_error($mysqli));
      ...
      <form id="change_password" class="form-signin" method="post">
		...
		<br>
		<a href="view_stud.php" title="Click to Edit" "  class="btn btn-inverse">Back</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;				
        <button  type="submit" data-placement="right" id="save" name="save" class="btn btn-success"><i class="icon-save icon-large"></i> Save</button>
			...
			jQuery("#change_password").submit(function(e){
					...
					$.ajax({
						...
						var delay = 2000;
							setTimeout(function(){ window.location = 'view_stud.php'  }, delay);  
						}
					});
					}
				});
