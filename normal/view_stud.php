            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="">
                     <div class="row-fluid">
                        ...
                        <div  id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-right">
										<a href="view_stud.php"><i class="icon-arrow-left icon-large"></i> Back</a>
								</div>
                            </div>
						...
						$query=mysqli_query($mysqli,"SELECT *,year(curDate())-year(DOB) as age,region.name, diocese.diocese_name,deanery.deanery_name,parish.parish_name,unit.unit_name,Login_tb.crusader_id FROM crusaders LEFT join region on crusaders.region=region.reg_id LEFT JOIN diocese ON crusaders.diocese = diocese.diocese_id LEFT JOIN deanery on crusaders.deanery=deanery.deanery_id LEFT JOIN parish on crusaders.parish=parish.parish_id LEFT JOIN unit on crusaders.unit=unit.unit_id LEFT JOIN Login_tb ON crusaders.crusader_id=Login_tb.crusader_id where Login_tb.crusader_id ='$get_id'") or die(mysqli_error($mysqli));
