            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="">
                     <div class="row-fluid">
						...
						<form id="add_student" class="form-signin" method="post" enctype='multipart/form-data'>
						<!-- span 4 -->
										<div class="span4">
										
											<label>PROFILE PICTURE:</label>
											<input type="hidden" class="input-block-level"  name="image" placeholder="First Name" >
						...
						<div class="span4">
											...
											<input type="date" class="input-block-level"  name="dob" placeholder="Date of Birth" required>
											<label>ADDRESS:</label>
