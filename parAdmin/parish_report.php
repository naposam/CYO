...
<body >
        ...
        <div class="container-fluid">
           ...
           $query=mysqli_query($mysqli,"SELECT DISTINCT(parish.parish_name),parish.*,annual_registration_paymenttbl.status from parish left JOIN annual_registration_paymenttbl  on annual_registration_paymenttbl.parish_id=parish.parish_id  where annual_registration_paymenttbl.status=1 and parish.parish_id='$parish_id'") or die(mysqli_error($mysqli));
