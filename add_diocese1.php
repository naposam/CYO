   	...
   	<?php include('validation.php');?>
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-plus-sign icon-large"></i> Add Diocese</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
								<form method="post" id="add_diocese">
										<div class="control-group">
                                          <div class="controls">
										  <label style="color: white; font-weight: bolder;">Diocese</label>
										  <input class="input focused"  name="diocese_name" id="focusedInput" type="text" placeholder = "Diocese Name" required onkeyup="letteronly(this)">
