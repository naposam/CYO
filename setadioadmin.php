...
<?php include('session.php'); ?>
    <body style="background: url(images/colorful.jpg) repeat scroll 0 0 rgba(0, 0, 0, 0) !important; background-repeat: no-repeat !important; background-size: cover !important;">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('sidebar_setDioAdmin.php'); ?>
				<div class="span3" id="">
								...
								<form action="delete_class1.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="80">
													<?php if($status!='diocAd'):?>
												<a data-placement="left" id="edit<?php echo $id; ?>" title="Click to Edit" href="set_edit_dioAdmin.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"></i>SET</a>
														<script type="text/javascript">
														$(document).ready(function(){
												...
												<td >
        <?php if($status=='diocAd'):?>
			<a href="unset_dio_admin.php?unset_id=<?php echo $row['crusader_id'];?>" onclick="return confirm('Are you sure you want to remove administrative right from this user ?');" class="btn btn-danger" id="delete<?php echo $row['diocese_id'];?>" title="Click to delete " data-toggle="modal">UNSET</a>
            <script type="text/javascript">
			$(document).ready(function(){
